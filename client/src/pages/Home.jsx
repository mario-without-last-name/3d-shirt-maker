...
const Home = () => {
  ...
  return (
    <AnimatePresence>
      {snap.intro && ( //currently on the intro/home page?
          ...
          <motion.div className='home-content' {...headContainerAnimation}>
            ...
            <motion.div {...headContentAnimation} className='flex flex-col gap-5'>
              <p className='max-w-md text-base font-normal text-gray-600'>
                Create your unique and exclusive shirt with our brand-new 3D customization tool. <strong>Unleash your imagination</strong> and define yout own style.
              </p>
